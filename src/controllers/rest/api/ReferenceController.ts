...
import { Description, Example, Get, Returns, Summary } from "@tsed/schema";
...
export class ReferenceController {
  ...
  @Returns(200, ReferenceFetchResultModel).Description("All the references for the given ligand ID.").Schema(ReferenceFetchResultSchema)
